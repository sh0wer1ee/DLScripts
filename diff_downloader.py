...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201127_aBYpbLFVwmiOGOrC'
    old_manifest_folder = 'prs_manifests_archive/20201126_3LpNo8zQRmEBWpKY'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201127'
    filter_str = None
