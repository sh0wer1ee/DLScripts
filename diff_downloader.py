...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201109_2WwgQ0wZyx4oYt7S'
    old_manifest_folder = 'prs_manifests_archive/20201106_yuTLFybqCfp3ydsw'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201109'
    filter_str = None
