...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201106_yuTLFybqCfp3ydsw'
    old_manifest_folder = 'prs_manifests_archive/20201104_bLJAeZLv7OyXr5vC'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201106'
    filter_str = None
