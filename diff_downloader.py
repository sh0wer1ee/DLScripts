...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201215_PQ4QGdAoBUsWzYC1'
    old_manifest_folder = 'prs_manifests_archive/20201214_w3z3UrxBrkDE8Jsq'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201215'
    filter_str = None
