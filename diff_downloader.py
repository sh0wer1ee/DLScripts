...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201116_0RerC7y9c9oBQ2mK'
    old_manifest_folder = 'prs_manifests_archive/20201113_ziG2a3wZmqghCYnc'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201116'
    filter_str = None
