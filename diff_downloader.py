...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201102_i2KQUEjJSBn8arFS'
    old_manifest_folder = 'prs_manifests_archive/20201030_3onIYAGX7C8sVusx'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201102'
    filter_str = None
