...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201225_fz63RBXOSXXWOzag'
    old_manifest_folder = 'prs_manifests_archive/20201223_UOWfZfLZ5nbBwIki'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201225'
    filter_str = None
