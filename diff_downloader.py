...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201218_zzMasNuJvEhRLhoR'
    old_manifest_folder = 'prs_manifests_archive/20201215_PQ4QGdAoBUsWzYC1'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201218'
    filter_str = None
