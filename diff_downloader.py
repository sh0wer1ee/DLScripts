...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201130_5PTeAdEsB0WYRzxy'
    old_manifest_folder = 'prs_manifests_archive/20201127_aBYpbLFVwmiOGOrC'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201130'
    filter_str = None
