...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201223_UOWfZfLZ5nbBwIki'
    old_manifest_folder = 'prs_manifests_archive/20201222_Bo2BR7JVzv8hlu3T'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201223'
    filter_str = None
