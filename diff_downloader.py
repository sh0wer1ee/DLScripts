...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201228_zD3NCu1eqObsWSK4'
    old_manifest_folder = 'prs_manifests_archive/20201225_fz63RBXOSXXWOzag'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201228'
    filter_str = None
