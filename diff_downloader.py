...
if __name__ == '__main__':
    #--Default--
    new_manifest_folder = 'prs_manifests_archive/20201207_gh2V8gX93j1K5xyD'
    old_manifest_folder = 'prs_manifests_archive/20201130_5PTeAdEsB0WYRzxy'
    lang = 'zh_cn'
    localized_only = False
    folder_name = '20201207'
    filter_str = None
